...
export const addNotes = (notes, note, setNotes, saveNotesToLocalStorage, uuidv4) => {
...
export const deleteNotes = (notes, id, currentPage, setCurrentPage, setNotes, saveNotesToLocalStorage, notesPerPage) => {
...
export const editNotes = (notes, updatedNote, setNotes, saveNotesToLocalStorage) => {
